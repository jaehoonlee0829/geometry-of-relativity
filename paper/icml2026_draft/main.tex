...
Linear readouts recover $z$ in early layers, while direct residual-stream steering with the layerwise \primalz{} direction is strongest in later layers.
...
Resample ablation --- replacing the head's last-token output with the same head's output drawn from a randomly chosen other prompt in the dataset --- performs very strongly at removing relativity from the model, reducing the partial correlation by $0.86$ with 8 heads chosen by DLA. Throughout this section ``ablation'' therefore refers to resampling.
...
\begin{figure}[!tbp]
  \centering
  \includegraphics[width=\linewidth]{figures/p2s_dla_vs_cossigma_sweep_gemma2-2b.png}
...
\begin{figure}[!tbp]
  \centering
  \includegraphics[width=\linewidth]{figures/p2v_xk_phase_grid_gemma2-2b_height.png}
...
\begin{figure}[!tbp]
  \centering
  \includegraphics[width=\linewidth]{figures/p2v_xk_deltar_overlay_gemma2-2b_height.png}
...
\begin{figure}[!tbp]
  \centering
  \includegraphics[width=\linewidth,keepaspectratio]{figures/xmodel_geometry_grid.png}
...
\begin{figure}[!tbp]
  \centering
  \includegraphics[width=\linewidth,keepaspectratio]{figures/xmodel_interventions_grid.png}
