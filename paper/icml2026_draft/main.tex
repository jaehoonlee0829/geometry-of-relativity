...
Ascending and descending contexts are especially adversarial to a simple recency heuristic, while alternating low/high contexts make the range visually salient.
...
Normal and bimodal contexts are the cleanest contrast: in the bimodal case, values between the two modes are relatively sparse and the middle of the standardized $z$ range is slightly less smooth, especially near the gap between modes.
Even so, the LD-by-$z$ curves remain ordered by relative standing rather than collapsing to raw magnitude.
...
The sharpest stress test is the extreme OOD-world setting, where raw magnitude and local standing can point in opposite semantic directions:
\begin{itemize}
