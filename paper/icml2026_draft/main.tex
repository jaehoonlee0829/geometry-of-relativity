...
\begin{figure}[!tbp]
  ...
  Representative domains show high-minus-low adjective logit difference against relative standing $z$ for ordinary in-distribution contexts and for artificial low/high OOD worlds.
  Full eight-domain curves are shown in \cref{fig:ood-robustness-full}.
...
Second, cross-pair steering with a source concept's \primalz{} direction often shifts the target concept in the expected high-minus-low direction; the full $z$-versus-$x$ transfer control is shown in \Cref{fig:z-vs-x-transfer}.
