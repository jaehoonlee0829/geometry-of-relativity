...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/fig_results_pca_all_pairs_clean.png}
...
The shot-sweep and ablation experiments make this more concrete by plotting behavior in a two-axis phase plane:
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/fig_results_relative_objective_phase_clean.png}
  \caption{\textbf{Relative/objective phase plane for shot-sweep and interventions.}
  Each panel places model behavior on two axes: relative use, measured by partial correlation with $z$ after accounting for $x$, and objective use, measured by partial correlation with $x$ after accounting for $z$.
  ...
  % Source artifact: internal/kshot/phase/figures/p2d_phase_grid_partial.png, cropped to remove the internal global title.
  }
...
The V13 raw-value control makes the comparison sharper: when we repeat the same 8-by-8 transfer experiment using raw-$x$ directions, transfer is much weaker.

\begin{figure*}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/fig_results_z_vs_x_transfer_clean.png}
  \caption{\textbf{Relative-standing directions transfer more broadly than raw-value directions.}
  ...
  Mean off-diagonal transfer is $+0.026$ for relative-standing directions versus $+0.006$ for raw-value directions.
  % Source artifact: results/v13/x_transfer/cross_pair_transfer_x_8x8.json, replotted for paper display.
  }
